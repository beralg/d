...
+function($, window, document, undefined){
    ...
    var Toast = {
      default : {
        "title": "Loading...", // <String>æç¤ºçš„å†…å®¹ï¼Œé»˜è®¤ï¼š"åŠ è½½ä¸­..."
        "icon": "loading", // <String>å›¾æ ‡ï¼Œæœ‰æ•ˆå€¼ "success", "loading", "none", "error"ï¼Œé»˜è®¤"loading"
        "image": "", // <String>è‡ªå®šä¹‰å›¾æ ‡çš„æœ¬åœ°è·¯å¾„ï¼Œimage çš„ä¼˜å…ˆçº§é«˜äºŽ icon
        "duration": 1500, // <Number>æç¤ºçš„å»¶è¿Ÿæ—¶é—´ï¼Œå•ä½æ¯«ç§’ï¼Œé»˜è®¤ï¼š1500(è®¾ç½®ä¸º0æ—¶ä¸è‡ªåŠ¨å…³é—­)
      },
